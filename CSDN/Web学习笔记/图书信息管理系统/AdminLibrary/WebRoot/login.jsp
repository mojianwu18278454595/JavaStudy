...
<BODY>
<FORM id=form1 name=form1 action="reader_login.action" method="post" target="_parent">
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150><INPUT id="rd_name" 
                  style="WIDTH: 130px" name="rd_name"></TD>
                <TD style="HEIGHT: 28px" width=370><SPAN 
                  id=RequiredFieldValidator3 
                  style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white">请输入登录名</SPAN></TD></TR>
              <TR>
                <TD style="HEIGHT: 28px">登录密码：</TD>
                <TD style="HEIGHT: 28px"><INPUT id="rd_pwd" style="WIDTH: 130px" 
                  type=password name="rd_pwd"></TD>
