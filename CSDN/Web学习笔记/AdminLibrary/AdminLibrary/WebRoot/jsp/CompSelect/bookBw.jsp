...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/compSelect_bookBw.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：综合查询&缴费办理 &gt; 图书借阅记录查询</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="bk_id"></TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												<TR
													...
													<s:iterator var="entry" value="bookBws">
												<TR
