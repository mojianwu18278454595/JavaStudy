							...
							<form>
								...
								<div>
									<div class="col-md-4 in-contact">
										<span>用户编号</span>
										<input type="text" id="detailID" value="<%=id%>">
									</div>
									<div class="col-md-4 in-contact">
										<span>用户名</span>
										<input type="text" id="detailName" value="<%=username%>">
									</div>
									<div class="col-md-4 in-contact">
										<span>用户类型</span>
										<input type="text" id="detailType" value="<%=type%>">
									</div>
									<div class="col-md-4 in-contact">
										<span>性别</span>
										<input type="text" id="detailSex" value="<%=gender%>">
									</div>
									<div class="col-md-4 in-contact">
										<span>Tel</span>
										<input type="text" id="detailTel" value="<%=tel%>">
									</div>
									<div class="col-md-4 in-contact">
										<span>地址</span>
										<input type="text" id="detailAddress" value="<%=address%>">
									</div>
									<div class="clearfix"> </div>
								</div>
							</form>
