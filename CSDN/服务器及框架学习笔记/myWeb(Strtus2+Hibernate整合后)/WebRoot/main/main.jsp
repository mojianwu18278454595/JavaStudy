...
<div class="header">
	<div class="header-top">
		...
		<div class="col-sm-4 world">
			...
			当前用户:<s:property value="#session.userInfo.user_name"/>
					
					<p class="login"><a href="style/myLogin.jsp" value="" >登录</a>
					<script>
							$("#login").attr("href","main/myDetail.jsp");
							$("#login").html($session.get("username"));
					</script>
					<span>/</span><a  href="style/myRegister.jsp" value="">注册</a></p>
		...
		<div class="container">
			...
			<div class="col-sm-8 h_menu4">
				...
				<li><a class="color6" href="myDetail.action">个人中心</a></li>
			  </ul> 
			</div>
